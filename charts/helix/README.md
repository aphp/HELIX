...
| configuration.jupyterhub.profiles.user[0].cpu_limit | int | `5` |  |
| configuration.jupyterhub.profiles.user[0].cpu_guarantee | int | `2` |  |
| configuration.jupyterhub.profiles.user[0].memory_limit | string | `"16G"` |  |
| configuration.jupyterhub.profiles.user[0].memory_guarantee | string | `"8G"` |  |
...
| configuration.jupyterhub.profiles.collaboration[0].cpu_limit | int | `5` |  |
| configuration.jupyterhub.profiles.collaboration[0].cpu_guarantee | int | `2` |  |
| configuration.jupyterhub.profiles.collaboration[0].memory_limit | string | `"16G"` |  |
| configuration.jupyterhub.profiles.collaboration[0].memory_guarantee | string | `"8G"` |  |
